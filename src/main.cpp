...
int main()
{
    ...
    // Ask which sensor to use:
    char option;
    bool selectionPending = true;
    while(selectionPending){
        cout << "Select sensor to be used:" << endl;
        cout << "1. Laser" << endl;
        cout << "2. Radar" << endl;
        cout << "3. Both" << endl;
        cout << "0. Exit" << endl;
        ...
        switch (option) {
            case '1':
                ...
                fusionEKF.useLaser = true;
                break;
            case '2':
                fusionEKF.useRadar = true;
        ...
        if (s != "") {
            ...
            if (event == "telemetry") {
              // j[1] is the data JSON object
                ...
                RMSE = VectorXd(4);
                RMSE << 0, 0, 0, 0;
                if(fusionEKF.meas_processed){
                    ground_truth.push_back(gt_values);
                    estimations.push_back(estimate);
                    RMSE = tools.CalculateRMSE(estimations, ground_truth);
                    std::cout << "G.Truth: \t" << gt_values.transpose() << std::endl;
